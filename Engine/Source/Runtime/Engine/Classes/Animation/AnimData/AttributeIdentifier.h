...
struct FAnimationAttributeIdentifier
{
	...
	FSoftObjectPath GetScriptStructPath() const { return ScriptStructPath; }
...
struct FAnimationAttributeIdentifierArray
{
	...
	UPROPERTY()
	TArray<FAnimationAttributeIdentifier> AttributeIdentifiers;
};
