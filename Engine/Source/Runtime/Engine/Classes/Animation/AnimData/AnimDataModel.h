...
public:
	...
	ENGINE_API virtual FGuid GenerateGuid(const FGuidGenerationSettings& InSettings) const override;
#if WITH_EDITOR
	ENGINE_API virtual FString GenerateDebugStateString() const override;
