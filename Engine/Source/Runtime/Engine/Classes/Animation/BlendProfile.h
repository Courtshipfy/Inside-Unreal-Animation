...
class UBlendProfileProviderInterface : public UInterface
{
	GENERATED_BODY()
};
...
public:
	...
	const TObjectPtr<UBlendProfile> GetBlendProfile() const { return BlendProfile; }

	TObjectPtr<UObject> GetCustomProviderObject() const { return BlendProfileProvider.GetObject(); }
	...
	bool UsesSkeletonBlendProfile() const { return BlendProfileProvider.GetObject() == nullptr; }
...
public:
	 ...
	 */
	ENGINE_API float GetBoneBlendScale(int32 InBoneIdx) const override;
