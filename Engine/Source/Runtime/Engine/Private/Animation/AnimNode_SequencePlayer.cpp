...
bool FAnimNode_SequencePlayer::GetOverridePositionWhenJoiningSyncGroupAsLeader() const
{
...
bool FAnimNode_SequencePlayer::SetOverridePositionWhenJoiningSyncGroupAsLeader(bool InOverridePositionWhenJoiningSyncGroupAsLeader)
{
#if WITH_EDITORONLY_DATA
	bOverridePositionWhenJoiningSyncGroupAsLeader = InOverridePositionWhenJoiningSyncGroupAsLeader;
#endif

	if (bool* OverridePtr = GET_INSTANCE_ANIM_NODE_DATA_PTR(bool, bOverridePositionWhenJoiningSyncGroupAsLeader))
	{
		*OverridePtr = InOverridePositionWhenJoiningSyncGroupAsLeader;
		return true;
	}
