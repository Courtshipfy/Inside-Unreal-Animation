...
void UAnimBlueprintGeneratedClass::Link(FArchive& Ar, bool bRelinkExistingProperties)
{
 ...
 // 这依赖于整个类被完全加载，而 EDL 异步加载则不是这种情况，在这种情况下，函数是在 PostLoad 中生成的
...
#if WITH_EDITOR
void UAnimBlueprintGeneratedClass::HandleReinitializeObjectAfterCompile(UObject* Object) const
{
	InitializeAnimNodeData(Object, true);
}
...
void UAnimBlueprintGeneratedClass::InitializeAnimNodeData(UObject* DefaultObject, bool bForce) const
{
#if WITH_EDITOR
